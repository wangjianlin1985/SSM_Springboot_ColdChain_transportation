...
$(function () {
	...
	$('#nav').tree({
		       ...
		       text: "冷藏车管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ChillCar/chillCar_add.jsp"
			    	   	},
			    		{
			    	   		text: "冷藏车管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ChillCar/chillCar_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "冷藏车商品管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "CarProduct/carProduct_add.jsp"
			    	   	},
			    		{
			    	   		text: "冷藏车商品管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "CarProduct/carProduct_query_result.jsp"
			    	    },
			    	    {
			    	   		text: "商品温度报警",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "CarProduct/carProduct_queryWarning_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "实时温度管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Sswd/sswd_add.jsp"
			    	   	},
			    		{
			    	   		text: "实时温度管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Sswd/sswd_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻公告管理",
		...
		onClick : function (node) {
			if (node.url) {
				if(node.text == "冷藏车商品管理") 
					$('#tabs').tabs('close', "商品温度报警");
				if(node.text == "商品温度报警") 
					$('#tabs').tabs('close', "冷藏车商品管理");
