		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>ProductClass/frontlist">产品分类列表</a></li>
			    	<li role="presentation" class="active"><a href="#productClassAdd" aria-controls="productClassAdd" role="tab" data-toggle="tab">添加产品分类</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="productClassAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="productClass_productClassName" class="col-md-2 text-right">产品分类名称:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="productClass_productClassName" name="productClass.productClassName" class="form-control" placeholder="请输入产品分类名称">
							 </div>
						  </div>
				          <div class="form-group">
