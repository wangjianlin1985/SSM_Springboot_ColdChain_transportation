...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">运输温控系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 <li><a href="<%=basePath %>UserInfo/frontlist">用户</a></li>
                  -->
                <li><a href="<%=basePath %>ProductClass/frontlist">产品分类</a></li>
                <li><a href="<%=basePath %>Product/frontlist">产品</a></li>
                <li><a href="<%=basePath %>ChillCar/frontlist">冷藏车</a></li>
                <li><a href="<%=basePath %>CarProduct/frontlist">冷藏车商品</a></li>
                <li><a href="<%=basePath %>Sswd/frontlist">实时温度</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Sswd/sswd_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;实时温度上报</a></li>
                        <li><a href="<%=basePath %>Sswd/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我上报的温度</a></li>
