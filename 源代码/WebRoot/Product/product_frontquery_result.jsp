...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Product/frontlist">产品信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Product/product_frontAdd.jsp" style="display:none;">添加产品</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<productList.size();i++) {
            		...
            		Product product = productList.get(i); //获取到产品对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Product/<%=product.getProductId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=product.getProductPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		产品分类:<%=product.getProductClassObj().getProductClassName() %>
			     	</div>
			     	<div class="field">
	            		产品名称:<%=product.getProductName() %>
			     	</div>
			     	<div class="field">
	            		最低温度:<%=product.getZdwd() %>°C
			     	</div>
			     	<div class="field">
	            		最高温度:<%=product.getZgwd() %>°C
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productQueryForm" id="productQueryForm" action="<%=basePath %>Product/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="productClassObj_productClassId">产品分类：</label>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;产品信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="product_productId_edit" class="col-md-3 text-right">产品id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="product_productId_edit" name="product.productId" class="form-control" placeholder="请输入产品id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="product_productClassObj_productClassId_edit" class="col-md-3 text-right">产品分类:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productName_edit" class="col-md-3 text-right">产品名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productName_edit" name="product.productName" class="form-control" placeholder="请输入产品名称">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_productPhoto_edit" class="col-md-3 text-right">产品照片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productDesc_edit" class="col-md-3 text-right">产品介绍:</label>
		  	 <div class="col-md-9">
			 	<textarea name="product.productDesc" id="product_productDesc_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_zdwd_edit" class="col-md-3 text-right">最低温度:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_zdwd_edit" name="product.zdwd" class="form-control" placeholder="请输入最低温度">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_zgwd_edit" class="col-md-3 text-right">最高温度:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_zgwd_edit" name="product.zgwd" class="form-control" placeholder="请输入最高温度">
			 </div>
		  </div>
		  <div class="form-group">
...
<script>
//实例化编辑器
var product_productDesc_edit = UE.getEditor('product_productDesc_edit'); //产品介绍编辑器
	...
	$.ajax({
		...
		success : function (product, response, status) {
			if (product) {
				...
				$("#product_zdwd_edit").val(product.zdwd);
				$("#product_zgwd_edit").val(product.zgwd);
